...
## Project Information
- This project is focused on building the foundations of registration and login systems for a simple chat application. I will develop a **Java with Maven Project in NetBeans** that centers around secure user  authentication and a strict input validation.
